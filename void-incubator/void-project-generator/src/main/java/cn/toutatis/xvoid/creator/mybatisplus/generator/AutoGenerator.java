 ...
 * the License.
 */
package cn.toutatis.xvoid.creator.mybatisplus.generator;
...
import cn.toutatis.xvoid.creator.mybatisplus.generator.engine.AbstractTemplateEngine;
...
public class AutoGenerator {
    ...
    public void execute() {
        ...
        if (null == templateEngine) {
            ...
            // 2020-06 - 11 Toutatis_Gc 改变为Freemarker引擎
            templateEngine = new FreemarkerTemplateEngine();
        }

        // 模板引擎初始化执行文件输出
        templateEngine.init(this.pretreatmentConfigBuilder(config)).mkdirs().batchOutput().open();
        logger.debug("[生成]文件生成完成.");
    }
