 ...
 * the License.
 */
package cn.toutatis.xvoid.creator.mybatisplus.generator.config.builder;
...
import cn.toutatis.xvoid.creator.mybatisplus.generator.config.po.TableField;
import cn.toutatis.xvoid.creator.mybatisplus.generator.config.po.TableFill;
import cn.toutatis.xvoid.creator.mybatisplus.generator.config.po.TableInfo;
import cn.toutatis.xvoid.creator.mybatisplus.generator.config.querys.H2Query;
...
//        packageInfo.put(ConstVal.INDEX, joinPackage(config.getParent(), config.getPage()));
        ...
        if (null != configPathInfo) {
            ...
            String xmlPath = currentChoosePath+"/src/main/resources/mapper/xml/";
            setPathInfo(pathInfo, template.getXml(), xmlPath, ConstVal.XML_PATH, ConstVal.XML);
...
//            }
            ...
            if (StringUtils.isNotBlank(globalConfig.getIndexName())) {
                tableInfo.setIndexName(String.format(globalConfig.getIndexName(), entityName));
            } else {
